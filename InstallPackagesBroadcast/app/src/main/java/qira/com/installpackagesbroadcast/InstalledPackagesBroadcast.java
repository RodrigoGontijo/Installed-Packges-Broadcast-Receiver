...
public class InstalledPackagesBroadcast extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (data.toString().equals("package:" + "com.qira.biometria.generica")) {
            Intent launchIntent = context.getPackageManager().getLaunchIntentForPackage("com.qira.biometria.generica");
